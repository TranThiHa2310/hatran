package com.example.sd29_depneko.controller;

import com.example.sd29_depneko.entity.Customer;
import com.example.sd29_depneko.repository.CustomerRepository;
...
public class CustomerController {
    ...
    public String filterByCity(@RequestParam("city") String city, Model model) {
        ...
        return "khach-hang"; // Tên của trang JSP hiển thị danh sách khách hàng
